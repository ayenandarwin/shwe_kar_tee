...
import 'package:shweluckypro/screen/2D/comment.dart';

import '../../utils/constants.dart';

class TwoDWinnersScreen extends StatefulWidget {
  const TwoDWinnersScreen({super.key});

  @override
  State<TwoDWinnersScreen> createState() => _TwoDWinnersScreenState();
}

class _TwoDWinnersScreenState extends State<TwoDWinnersScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
            ...
            children: [
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildWinnerCard("ကံကောင်း", "0996*****45"),
                    _buildWinnerCard("Ko Hein", "0978*****90"),
                  ],
                ),
              ),
              Container(
                ...
                child: Center(
                  child: _buildWinnerLargeCard("ကံကောင်း", "0944*****78"),
                ),
              ),
            ],
          ),
          ...
          Column(
            children: [
              _buildSingleCard(1, "Kochit", '0926*****49', 2500, "2375,000"),
              _buildSingleCard(2, "HHW", '0926*****49', 2500, "2375,000"),
              _buildSingleCard(3, "Ko Phyo", '0926*****49', 2500, "2375,000"),
              _buildSingleCard(4, "Ko Hla", '0926*****49', 2500, "2375,000"),
              _buildSingleCard(4, "Su Su", '0926*****49', 2500, "2375,000"),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () => Get.to(TwoDCommentScreen()),
                child: Container(
                  width: MediaQuery.of(context).size.width * 0.09,
                  height: MediaQuery.of(context).size.height * 0.033,
                  //margin: EdgeInsets.only(right: 16),
