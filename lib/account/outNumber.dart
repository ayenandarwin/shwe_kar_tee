...
class OutputNumberScreen extends StatefulWidget {
  const OutputNumberScreen({super.key});

  @override
  State<OutputNumberScreen> createState() => _OutputNumberScreenState();
}

class _OutputNumberScreenState extends State<OutputNumberScreen> {
  @override
